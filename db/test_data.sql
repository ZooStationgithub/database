...
VALUES
	(1, 'su', sha1('su'), subdate(current_timestamp(), 10), current_timestamp(), 1)
;
...
-- Add profile
INSERT INTO `profiles` (`id`, `zs_number`, `main_pr_lng_id`, `second_pr_lng_id`, `test_rating`, `origin_country_id`, `visa_needed`, `company_type`, `experience`, `work_history`, `english_level`, 
						`travel_time`, `preferred_city`, `availability`, `hours_per_week`, `relocation_reason`, `contract_type_id`)
VALUES
	(1, '4567890', 1, 4, 40, 100, 0, 2, 3, 'trakaalalalal', 3, 40, 'Amsterdam', 3, 40, 'frjfoprffrf frf', 1),
    (2, '4567891', 4, 1, 40, 100, 0, 2, 3, 'trakaalalalal', 3, 40, 'Amsterdam', 3, 40, 'frjfoprffrf frf', 1),
    (3, '4567892', 3, null, 40, 100, 0, 2, 3, 'trakaalalalal', 3, 40, 'Amsterdam', 3, 40, 'frjfoprffrf frf', 1)
;
