...
<div class="col-xs-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading clearfix">
            ...
            <label id="btnNewFramework" class="btn btn-xs btn-danger pull-right">
                <spring:message code="common.keyword.new"/>
            </label>
        </div>
        <div class="panel-body">
            <table id="framework-grid" class="table table-hover">
                <thead>
                <tr>
                    <th><spring:message code="common.keyword.id"/></th>
                    <th><spring:message code="common.keyword.name"/></th>
                    <th><spring:message code="form.framework.pl"/></th>
                    <th></th>
                    <th></th>
                </tr>
                </thead>
    ...
    <div id="panelFormFramework" class="panel panel-default">
