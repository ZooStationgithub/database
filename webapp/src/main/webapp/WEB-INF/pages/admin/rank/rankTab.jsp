...
<div class="col-xs-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading clearfix">
            ...
            <label id="btnNewRank" class="btn btn-xs btn-danger pull-right">
                <spring:message code="common.keyword.new"/>
            </label>
        </div>
        <div class="panel-body">
            <table id="rank-grid" class="table table-hover col-xs-12">
                <thead>
                <tr>
    ...
    <div id="panelFormRank" class="panel panel-default">
