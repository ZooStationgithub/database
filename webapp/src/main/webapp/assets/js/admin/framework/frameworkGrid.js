 ...
 */
FrameworkGrid = function (tabContext) {
...
FrameworkGrid.prototype = function () {
    ...
    var gridSelector = '#framework-grid';
    ...
    var definition = {
        ajax: '/admin/data/framework/grid',
        processing: true,
        serverSide: true,
        filter: false,
        scrollX: true,
        columns: [columns.id, columns.name, columns.pl, columns.edit, columns.delete]
    };
    ...
    var init = function (thisObj) {
        ...
        $('#btnNewFramework').on('click', handlers(thisObj).clickNew);
