 ...
 */
ProgrammingLanguageGrid = function (tabContext) {
...
ProgrammingLanguageGrid.prototype = function () {
    ...
    var init = function (thisObj) {
        ...
        $('#btnNewPl').on('click', handlers(thisObj).clickNew);
