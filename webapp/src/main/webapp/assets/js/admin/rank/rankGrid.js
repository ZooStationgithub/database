 ...
 */
RankTypeGrid = function (tabContext) {
...
RankTypeGrid.prototype = function () {
    ...
    var init = function (thisObj) {
        ...
        $('#btnNewRank').on('click', handlers(thisObj).clickNew);
