 ...
 */
RoleTypeGrid = function (tabContext) {
...
RoleTypeGrid.prototype = function () {
    ...
    var init = function (thisObj) {
        ...
        $('#btnNewRole').on('click', handlers(thisObj).clickNew);
